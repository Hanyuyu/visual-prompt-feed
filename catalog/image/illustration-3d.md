...
## Miniature 3D papercraft and clay-diorama illustration of London postcard

- **Original source:** [@john_my07 on X](https://x.com/john_my07/status/2088124379775566200)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `illustration-3d`
- **ImgLume record:** [2973](https://imglume.com/prompt/2973)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/177465a7-77ac-4bbb-8d05-1317f70da7e0/64afa7fe-53a5-4d31-aa0e-9a42b3bfa2a2-1786729933521 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/177465a7-77ac-4bbb-8d05-1317f70da7e0/f2a440bf-615c-4c81-8f5c-d28558a5362b-1786729933521 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/177465a7-77ac-4bbb-8d05-1317f70da7e0/0726b269-5eb2-411f-9823-5bfa870f841d-1786729933521 "Image prompt preview") · [4](https://cdn.imglume.com/prompts/byradar/177465a7-77ac-4bbb-8d05-1317f70da7e0/8618f1c0-af86-4671-832f-a7cadd59ee59-1786729933521 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>Create a charming miniature 3D papercraft and clay-diorama illustration of London, England, presented like a premium handcrafted souvenir postcard. Set the scene on a rounded cobblestone island over a warm off-white textured paper background.

Feature miniature Big Ben and the Palace of Westminster, the London Eye, Tower Bridge, and classic red double-decker buses, surrounded by elegant Victorian architecture, narrow streets, tiny black cabs, and the River Thames flowing through the composition. Add miniature Londoners in stylish everyday British clothing, tiny Union Jack details, street lamps, flower planters, café tables, newspaper stands, red telephone booths, and subtle London street signs.
...
Compose the diorama from a slightly elevated three-quarter perspective, with a polished yet handmade feel and beautifully balanced visual density. Place elegant cursive lettering beneath the miniature diorama, integrated naturally into the postcard design.</code></pre>
...
- **Original source:** [@codewithhajra on X](https://x.com/codewithhajra/status/2083130474075918811)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `illustration-3d`
- **ImgLume record:** [1970](https://imglume.com/prompt/1970)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/9467fcb7-ce4e-4aab-8f3a-4059ec6df08d/e795f0e0-8840-424c-aa79-42fad7ffb881-1785513276338 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/9467fcb7-ce4e-4aab-8f3a-4059ec6df08d/d6c944db-787b-4dfc-9ad6-2c1a05687009-1785513276338 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>Transform the uploaded person into a heartwarming Pixar-inspired 3D chibi scene while preserving the exact facial identity, facial structure, hairstyle, skin tone, expression, outfit, colors, and recognizable appearance from the reference image.
...
MAIN CHARACTER
Create a premium Pixar-style 3D chibi version of the uploaded person sitting comfortably on top of giant pastel 3D letters spelling "GOOD MORNING." The character should have a warm smile and relaxed pose while holding a ceramic coffee mug. The mug should remain simple with no visible text or logo.

MINI CHARACTERS
Surround the main character with multiple adorable miniature versions of the same person, each performing a different cheerful morning activity: pouring coffee, holding an encouraging sign, enjoying a coffee, reading a book, watering a small plant, hugging a pink heart, serving a cupcake, and raising a motivational chalkboard. Every mini character must preserve the same recognizable facial identity in a playful Pixar-style design.
...
NEGATIVE PROMPT
Avoid low quality, blurry details, distorted face, changed identity, altered outfit, extra limbs, duplicate main character, bad anatomy, plastic textures, cluttered composition, dark lighting, harsh shadows, logos, watermarks, text artifacts, or unrealistic 3D rendering.</code></pre>

</details>

## Stylized collectible toy with premium packaging

- **Original source:** [@Madhuribhai on X](https://x.com/Madhuribhai/status/2082989921024049622)
- **Recommended model:** `nanobanana`
- **Source model(s):** `nanobanana`
- **Categories:** `illustration-3d`
- **ImgLume record:** [1952](https://imglume.com/prompt/1952)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/6b122d3b-590c-45c7-a978-5668cbe23f93/e5b1b32c-36bb-440c-a67a-7fbc4f6ee021-1785513125073 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/6b122d3b-590c-45c7-a978-5668cbe23f93/ee2c1155-370b-49dd-aced-2abb2588b0a3-1785513125073 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/6b122d3b-590c-45c7-a978-5668cbe23f93/079e0c69-0239-46bb-b85c-d4824ea90277-1785513125073 "Image prompt preview") · [4](https://cdn.imglume.com/prompts/byradar/6b122d3b-590c-45c7-a978-5668cbe23f93/b9834b3e-8751-4edd-8373-2519f5995872-1785513125073 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>"Transform the subject into a stylized collectible toy with glossy plastic textures, exaggerated features, miniature accessories, and premium blister-pack retail packaging with a cardboard backer."</code></pre>

</details>

## Pop-up postcard diorama of \[CITY\], \[COUNTRY\]

- **Original source:** [@Goodmanprotocol on X](https://x.com/Goodmanprotocol/status/2083033777052553483)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `illustration-3d`
- **ImgLume record:** [1939](https://imglume.com/prompt/1939)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/68ed2a25-5d88-48a1-aa8b-d97f39305472/b554dae7-3f91-430a-8ebf-cbe77d0120a5-1785490876525 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/68ed2a25-5d88-48a1-aa8b-d97f39305472/f99ece19-54ae-431b-91c9-fb43fb126f26-1785490876525 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/68ed2a25-5d88-48a1-aa8b-d97f39305472/13add8d9-adda-4e9a-b36f-c3cc732f7880-1785490876525 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>A highly detailed, photorealistic, Instagram-worthy diorama in the form of an open pop-up travel postcard standing upright on a locally authentic stone or pavement ledge, featuring [CITY], [COUNTRY]. Vertical 3:4 portrait composition.

CAMERA &amp; COMPOSITION (critical):
Static camera at eye level, angled 25 degrees off-axis to the left for a three-quarter view — paper thickness, forward curve, and the horizontal base panel folding toward the viewer clearly visible. The card occupies roughly 65% of the frame, fully contained, with generous breathing room on all four sides and open sky above its top edge. Never crop the card. Vertical fold slightly left of center: flat printed left panel for all text and ink work, papercraft rising on the right. Natural sky matching the destination fills the upper fifth.

FOREGROUND CARD:
Authentic vintage postcard, rounded corners, aged paper with a subtle decorative border inspired by the destination's visual identity, an authentic local postage stamp, handwritten travel note, circular [CITY] · [COUNTRY] postmark. Fine ink illustrations of two small iconic local symbols placed low on the flat left panel.

POP-UP WORLD:
The right panel opens into a layered paper world featuring the destination's most recognizable historic street, neighborhood, or architectural setting, with authentic local buildings, streets, vegetation, textures, decorative details, and cultural elements. Include one iconic landmark or transport element naturally integrated into the scene. All papercraft stays strictly inside the card's silhouette; the tallest element rises no higher than the card's top edge.

CHARACTER:
A stylized collectible 3D traveler figure with realistic proportions and cinematic figurine quality. Outfit should match the destination's climate and travel aesthetic, carrying subtle travel accessories. The traveler stands naturally within the pop-up environment, facing away from the camera while admiring the scenery. Hair and clothing respond naturally to the local breeze.

BACKGROUND:
Softly blurred realistic panoramic view of [CITY], clearly readable around all sides of the card. Card razor sharp, background deep creamy bokeh.

Architecture:
Use authentic regional architecture, materials, roof styles, streets, decorative details, vegetation, and urban character unique to [CITY].

Landmarks:
Limit to a maximum of 2 recognizable landmarks or iconic local features.

Palette:
Use the destination's naturally recognizable architectural, environmental, and cultural colors.

Headline in a modern handwritten font:
"[CITY]."
"[COUNTRY]."
...
Luxurious travel editorial aesthetic, clear warm afternoon light raking from the left, shallow depth of field, cinematic color grading, realistic cast shadow on the stone or pavement ledge, ultra-detailed papercraft, travel magazine cover quality, photorealistic, 8K, masterpiece. All text clearly legible. No extra people, additional vehicles, objects, or text.</code></pre>

</details>

## Minimalist 3D clay illustration with bold typography and stylized character

- **Original source:** [@Goodmanprotocol on X](https://x.com/Goodmanprotocol/status/2082831844350087258)
- **Recommended model:** `gptimage`
- **Source model(s):** `gptimage`
- **Categories:** `illustration-3d`
- **ImgLume record:** [1937](https://imglume.com/prompt/1937)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/6cd69e8f-abcf-4957-be73-7bb66da8d18e/5b07574d-29f5-4e5e-b1ec-869093cb0623-1785484591825 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/6cd69e8f-abcf-4957-be73-7bb66da8d18e/80c5d3c3-1858-483f-a342-1ce2ecb45e91-1785484591825 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/6cd69e8f-abcf-4957-be73-7bb66da8d18e/371344aa-578d-4895-8187-616d06348bdc-1785484591825 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>Minimalist 3D clay illustration. Giant bold typography reading "[TEXT]"
...
A cute stylized clay character stands IN FRONT of the letters,
overlapping them, full body visible from head to sneakers. The
letters remain fully readable behind — the character never sits on,
climbs, or merges into them.

CHARACTER: chubby handmade proportions, oversized round head, big
glossy black dot eyes, tiny smiling mouth, soft blush cheeks, mitten
hands. [CHARACTER DESCRIPTION].
NOTE: the character wears NO colors matching the letters — use
contrasting colors only, so the character separates cleanly from the
typography.

ACTION: [ACTION DESCRIPTION]. Body overlaps the first and middle
letters; the final letter stays clear on the right.

SCALE: character height about 65% of the letter height, centered
slightly left.

ACCENTS: [NUMBER] small hand-drawn [ACCENT COLOR] motion dashes
trailing behind the character, one tiny doodled [ACCENT ELEMENT]
arcing in the upper right — thin flat 2D marks, not 3D.

RENDER: soft diffused studio light from upper left, gentle ambient
occlusion, matte clay surfaces throughout, clean white seamless
backdrop, slightly elevated eye-level camera, vertical 3:4.

NEGATIVE: glossy plastic, metallic sheen, gradients on the letters,
letters obscured or broken, character standing on or inside the
letters, extra text, readable text on props, misspelled words,
brand or commercial logos, realistic skin, harsh shadows,
colored background.</code></pre>
...
- **Original source:** [@Naiknelofar788 on X](https://x.com/Naiknelofar788/status/2081628890762826026)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `illustration-3d`
- **ImgLume record:** [1634](https://imglume.com/prompt/1634)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/51baecb9-e1f3-4c14-9cb2-8fd9983b21b2/104139de-bbac-4336-b131-a527e6d55a0d-1785151880761 "Sleepy") · [2](https://cdn.imglume.com/prompts/byradar/51baecb9-e1f3-4c14-9cb2-8fd9983b21b2/400ef929-1d89-4736-a81c-eb2fef7565c8-1785151880761 "Spending time with my pet") · [3](https://cdn.imglume.com/prompts/byradar/51baecb9-e1f3-4c14-9cb2-8fd9983b21b2/a5129212-87d8-40ec-b299-6ba993350539-1785151880761 "photography is my hobby") · [4](https://cdn.imglume.com/prompts/byradar/51baecb9-e1f3-4c14-9cb2-8fd9983b21b2/24f34ea0-73f8-4532-9dd7-49018fb6fa46-1785151880761 "Content creation is my job")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>[SUBJECT], ultra realistic 3D render, smooth inflated glossy plastic material, soft pillowy balloon like contours, subtle stitched panel seams and paneling, high specular highlights, clean reflections, soft contact shadows, designer collectible toy aesthetic, cute proportions, premium polished finish, floating centered, plain light gray studio background, soft diffused studio lighting, sharp focus, high resolution, 8k, 1:1, no text, no logo, no watermark</code></pre>

</details>

## Ultra-refined ethereal fantasy realism digital illustration

- **Original source:** [@HustleXR on X](https://x.com/HustleXR/status/2081373736817844274)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `illustration-3d`
- **ImgLume record:** [1602](https://imglume.com/prompt/1602)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/655192c2-4707-4a30-a65d-2fd94bd3608f/e152ed6a-09cb-4a8b-9696-d995ee5a3002-1785145583351 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/655192c2-4707-4a30-a65d-2fd94bd3608f/ddd8b4bc-b305-4c04-a50c-8e969dec8e6f-1785145583351 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/655192c2-4707-4a30-a65d-2fd94bd3608f/68dfb259-cf5e-4e44-9823-83f621c6eaab-1785145583351 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>Ultra-refined ethereal fantasy realism blended with classical Art Nouveau elegance, romantic symbolist painting, and premium mixed-media digital illustration. Hyper-realistic porcelain skin rendered with flawless soft gradients, luminous subsurface scattering, and velvety matte textures. Intricately layered natural elements—including delicate bird feathers, dried botanical foliage, butterflies, vines, flowers, and organic ornaments—seamlessly integrated into the composition as sculptural extensions rather than accessories. Rich atmospheric depth created through overlapping translucent forms, soft painterly blending, and highly detailed organic textures.
Muted cinematic color palette featuring warm ivory, parchment beige, weathered gold, soft ochre, pale amber, muted taupe, smoky gray, deep charcoal, desaturated teal, and midnight blue. Sophisticated warm–cool color harmony with gentle golden highlights against cool shadow tones. Soft volumetric lighting, subtle ambient glow, feathered rim lighting, and elegant chiaroscuro emphasizing depth without harsh contrast.
Museum-quality painterly rendering with meticulous micro-details, ultra-smooth brush transitions, refined edge control, and handcrafted fine-art aesthetics. Dreamlike, poetic atmosphere enriched by delicate haze, layered transparency, faded textures, and graceful organic flow. Background remains softly abstract with painterly depth, seamlessly merging botanical silhouettes and natural forms into a luxurious, timeless fantasy composition. Highly detailed, cinematic, elegant, organic, immersive, premium fine-art masterpiece, 8K, ultra-high fidelity.</code></pre>
...
- **Original source:** [@artingent on X](https://x.com/artingent/status/2081003166217474475)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `illustration-3d`
- **ImgLume record:** [1555](https://imglume.com/prompt/1555)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/5b9fa10e-4779-4891-8aa4-e229ea3017bf/105a70ca-6c2d-4ed8-8789-c8d991bb05d9-1785061581392 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>TITLE: The Helios Terraforming Carrier

A massive autonomous heavy-duty terraforming truck designed to transform barren planets into habitable ecosystems. The colossal vehicle rides on twelve gigantic independently articulated wheel assemblies, each containing complex suspension mechanisms, armored shock systems, and adaptive terrain-control technology capable of traversing volcanic wastelands, toxic deserts, frozen plains, and unstable geological regions.

The massive truck should be at least 10 times the size of a normal truck. A normal grey colored LCV container truck should be parked somewhere nearby so that the scene emphasizes scale of the massive truck

The enormous rear structure houses atmospheric processors, climate-control reactors, water-generation systems, soil-manufacturing facilities, biological cultivation laboratories, seed vaults, ecological deployment bays, and autonomous environmental restoration systems. Gigantic deployment arms extend from the vehicle to plant forests, construct wetlands, and establish self-sustaining ecosystems. Massive external tanks carry atmospheric gases, water reserves, and biological resources for planetary restoration.

The command cab resembles a mobile environmental operations center with panoramic reinforced observation glass, advanced sensor arrays, communication towers, navigation radars, climate-analysis systems, and layered protective plating. Every section is packed with mechanical detail including hydraulic systems, exposed engineering components, power conduits, cooling infrastructure, access panels, maintenance platforms, warning lights, atmospheric machinery, ecological deployment systems, autonomous drones, and industrial machinery. Brutalist industrial design, cinematic scale, highly detailed mechanical engineering, photorealistic rendering, masterpiece quality, 8K.</code></pre>
