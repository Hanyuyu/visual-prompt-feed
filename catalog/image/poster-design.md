...
- **Original source:** [@Diplomeme on X](https://x.com/Diplomeme/status/2087872724941316122)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `poster-design`
- **ImgLume record:** [2959](https://imglume.com/prompt/2959)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/c6254e05-dadc-473e-8248-37dedd2b25d2/b82f5812-7f44-4a03-b60b-5803cc1c20df-1786707294202 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/c6254e05-dadc-473e-8248-37dedd2b25d2/5d578e45-1fcc-450c-be6f-ef065da7e3f0-1786707294202 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/c6254e05-dadc-473e-8248-37dedd2b25d2/21b98b1b-d23c-4732-b672-ea4659451a0e-1786707294202 "Image prompt preview") · [4](https://cdn.imglume.com/prompts/byradar/c6254e05-dadc-473e-8248-37dedd2b25d2/f00ab47f-ec9d-4a6d-a9cb-f5a166af76a0-1786707294202 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>PROJECT Campaign: American Express Product: American Express Credit Card Objective: Create a high-end surrealist Instagram advertising poster that transforms the American Express credit card into an extraordinary visual symbol of access, possibility, and premium membership while preserving unmistakable product identity and commercial credibility. FORMAT Instagram social media advertising poster | 4:5 vertical | 1080 × 1350 px | high-resolution commercial artwork | Behance Featured-level visual design CREATIVE CONCEPT “THE FUTURE OF MEMBERSHIP.” Create a surreal visual world where the American Express credit card exists beyond ordinary physical reality. The card becomes the central object of an impossible luxury landscape, surrounded by dreamlike architectural forms and gravity-defying elements that communicate access to a world beyond the expected. The surrealism should feel intentional and sophisticated: impossible physics presented with photographic realism, creating a visual metaphor for the extraordinary possibilities associated with membership. ART DIRECTION Contemporary luxury surrealism combined with premium commercial photography and high-fashion editorial art direction. The visual language should feel intelligent, sophisticated, cinematic, minimal, and concept-driven rather than chaotic or psychedelic. Use impossible scale, unexpected spatial relationships, suspended objects, dreamlike architecture, reflective surfaces, and controlled distortions while maintaining a refined luxury aesthetic. Every surreal element must have a clear relationship with the American Express product and campaign message. HERO SUBJECT A physically accurate American Express credit card as the dominant hero object. The card must retain authentic proportions, recognizable geometry, premium surface construction, chip placement, typography, logo treatment, and overall product identity. Position the card dramatically within the surreal environment, appearing monumental and highly valuable. The card should remain immediately recognizable even within the impossible setting. Do not redesign, mutate, melt, stretch, duplicate, or deform the credit card. COMPOSITION 4:5 vertical editorial advertising composition. Place the American Express card prominently in the central visual hierarchy, occupying approximately 40–50% of the composition. Create an impossible perspective in which the surrounding environment appears dramatically larger or deeper than normal. Foreground: minimal surreal elements partially framing the scene. Midground: American Express credit card as the dominant visual anchor. Background: enormous dreamlike architectural structures extending into an impossible horizon. Create substantial negative space around the headline area. Use controlled asymmetry to create visual tension while maintaining balance. The viewer’s eye should move naturally from headline → card → surreal environment → supporting details. GRAPHIC SYSTEM Minimal graphic intervention. Use elegant surreal visual elements rather than conventional decorative graphics. Possible elements include: Floating architectural fragments Oversized geometric forms Impossible staircases Suspended glass structures Gravity-defying objects Reflective pools Floating doorways Distorted perspective planes Soft atmospheric particles Subtle translucent surfaces Elegant geometric shadows All elements must appear physically integrated into the environment. No random symbols, unnecessary UI, stickers, icons, or decorative clutter. TYPOGRAPHY Primary headline: “THE FUTURE OF MEMBERSHIP.” Large premium editorial typography with a refined modern grotesk or sophisticated contemporary sans-serif character. Use strong scale and generous spacing. Position the headline within the negative space created by the surreal environment. Secondary copy: “Membership has its privileges.” Small, restrained supporting typography beneath the headline. Typography should remain perfectly legible and sharply rendered. The type should feel integrated into the art direction rather than placed as an afterthought. Maintain a sophisticated advertising hierarchy with clear distinction between headline, supporting message, and brand information. COLOR SYSTEM Primary: deep American Express blue. Secondary: midnight blue, soft white, silver, muted cyan. Accent: subtle warm metallic highlights. Background: sophisticated blue atmospheric gradient transitioning into deeper shadows. Use restrained color contrast to maintain a premium luxury appearance. Avoid excessive saturation. The American Express blue should remain visually dominant enough to reinforce brand recognition without turning the entire image into a conventional corporate advertisement. ENVIRONMENT An impossible luxury architectural landscape combining monumental modernist architecture with dreamlike spatial proportions. Imagine an endless contemporary architectural plaza suspended above a vast atmospheric void. Massive geometric structures extend into the distance. Reflective surfaces create elegant visual echoes of the credit card. A calm atmospheric haze separates distant architecture from the hero product. The environment should feel expensive, mysterious, monumental, and almost otherworldly. No ordinary office, shopping mall, wallet, payment terminal, or conventional financial environment. LIGHTING DESIGN Large cinematic soft key light illuminating the hero card. Controlled cool ambient illumination throughout the environment. Subtle rim lighting around the card edges. Strong but elegant directional sunlight breaking through the architectural structures. Long architectural shadows creating depth and scale. Precise specular highlights across reflective surfaces. Soft atmospheric volumetric light in the distant environment. The impossible environment must obey believable photographic lighting. CAMERA / OPTICS High-end commercial photography aesthetic. Medium-format camera look. 85mm equivalent premium product/editorial lens. Low-to-medium camera angle emphasizing the monumental scale of the environment. Controlled perspective with subtle depth exaggeration. American Express card rendered in extremely sharp focus. Background architecture gradually loses clarity through atmospheric perspective rather than artificial blur. Deep dimensionality without excessive depth-of-field effects. The final image should look photographed inside a real impossible world rather than obviously generated CGI. MATERIAL RENDERING American Express card: premium realistic material, subtle micro-texture, precise edge definition, controlled reflections, physically accurate surface response. Architecture: refined stone, polished metal, glass, brushed aluminum, smooth concrete. Reflective surfaces: realistic reflections with physically coherent distortions. Glass: accurate transparency, refraction, thickness, and edge highlights. Atmosphere: realistic volumetric scattering and depth. Every surface should exhibit believable physical interaction with light. IMAGE CHARACTER Ultra-realistic commercial photography combined with sophisticated surrealist art direction. Photorealistic. High dynamic range without an artificial HDR appearance. Subtle cinematic grain. Natural highlight roll-off. Clean deep blacks. Smooth tonal transitions. Precise color grading. High micro-detail. Subtle atmospheric haze. No obvious AI-generated texture. No plastic CGI appearance. The final image should resemble a globally produced luxury advertising campaign photographed inside an impossible architectural world. BRAND INTEGRATION American Express branding must remain authentic and recognizable. Preserve the original identity and visual character of the credit card. The American Express logo and card details must remain clean, proportionally correct, and undistorted. Brand integration should be elegant and restrained. Do not invent financial claims, benefits, membership tiers, or product features. The product itself must remain the strongest brand identifier. ADVERTISING INTENT First impression: an impossible luxury world. Second impression: the American Express card. Third impression: membership represents access to extraordinary possibilities. The surreal environment should function as a visual metaphor for entering a world beyond ordinary expectations. The advertisement should create curiosity immediately while communicating premium positioning without relying on excessive copy. QUALITY CONTROL Exact 4:5 Instagram composition. Accurate American Express card proportions. Accurate product geometry. Authentic brand identity. Perfect typography. Correct spelling. Strong visual hierarchy. Physically believable surrealism. Consistent perspective. Realistic reflections. Realistic shadows. Coherent lighting. Natural atmospheric depth. Premium commercial color grading. No accidental objects. No duplicated credit cards. No distorted product details. No warped typography. No malformed chip. No floating objects that appear visually disconnected from the environment. NEGATIVE CONSTRAINTS No Y2K aesthetic. No cyberpunk. No excessive neon. No psychedelic visuals. No chaotic surrealism. No random floating objects. No generic luxury stock photography. No generic fintech advertisement. No excessive visual effects. No distorted American Express branding. No warped credit card. No duplicated product. No illegible typography. No excessive bloom. No artificial HDR. No cheap CGI appearance. No plastic-looking materials. No visual clutter. No unnecessary UI. No cartoon aesthetic. No low-resolution details. No generic AI-generated look. FINAL CREATIVE DIRECTION American Express × Contemporary Surrealism × Luxury Editorial Photography × Impossible Architecture × Premium Product Advertising. Make the impossible feel real, luxurious, intentional, and photographically believable. The final poster should feel like a globally produced American Express campaign and a Behance Featured art-direction project simultaneously.</code></pre>

</details>

## Minimal Layered Paper-Cut Travel Poster for New York City

- **Original source:** [@Goodmanprotocol on X](https://x.com/Goodmanprotocol/status/2087888777070940613)
- **Recommended model:** `gptimage`
- **Source model(s):** `other`
- **Categories:** `poster-design`
- **ImgLume record:** [2925](https://imglume.com/prompt/2925)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/8a12d5f6-0b6a-48ed-836c-49386f65ef00/6791ec26-481b-4e2c-a5bc-a9a699d89f37-1786667451788 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/8a12d5f6-0b6a-48ed-836c-49386f65ef00/2b4cfc1d-5074-483b-9de8-63833ac58d93-1786667451788 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/8a12d5f6-0b6a-48ed-836c-49386f65ef00/9be2733b-69d7-41fa-bd4e-d33eb9931e9c-1786667451788 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>Create a vertical 9:16 premium travel poster for {DESTINATION / CITY}, designed as a minimal handcrafted layered paper-cut collage.

Use a warm off-white background with subtle matte cardstock texture, visible fine paper fibers, crisp cut edges, soft dimensional relief, and delicate contact shadows.

Reserve the upper 22–25% as open negative space. Center the title “{DESTINATION / CITY}” at the top in dark navy uppercase geometric sans-serif lettering with wide tracking. No other text.

Below the title, include only two or three small minimal white paper clouds. Do not include any sun, circle, red dot, decorative disk, or similar graphic element.

Feature {PRIMARY LANDMARK / ICONIC ARCHITECTURE} as the single dominant centerpiece. Keep it simplified, iconic, and immediately recognizable, preserving only its most defining architectural forms and proportions. Avoid intricate sculptural detail. Reduce the landmark to clear layered paper shapes with elegant symmetry and strong silhouette.

Introduce {SECONDARY STRUCTURAL ELEMENT / ROAD / BRIDGE / LANDSCAPE FEATURE} as one smooth, simple paper form across the lower-middle composition. Behind the main landmark, place only a few simplified {CITY / DESTINATION} silhouettes as flat supporting layers, with {DISTANT LANDMARK} subtly hinted in the background if appropriate.

In the foreground, add a very minimal streetscape or environmental layer: a few soft sage paper tree shapes, one or two pale paving or ground layers, and exactly one small {SIGNATURE CITY ELEMENT / VEHICLE / OBJECT} as the single characteristic detail.

Keep the composition sparse, calm, balanced, and highly legible. Use only a small number of clean paper layers across foreground, middle ground, and background. Favor bold silhouettes over detail.

Limited palette: warm ivory, deep navy blue, muted blue-gray, sage green, plus one restrained accent color appropriate to the destination. Keep saturation sophisticated and subdued.

Use soft studio light from the upper left, casting subtle shadows toward the lower right. The overall effect should feel like a refined editorial paper collage: minimal, elegant, tactile, handcrafted, and premium.

No people, photorealism, painterly effects, neon colors, dense detail, complex windows, heavy gradients, thick outlines, clutter, logos, watermark, border, extra text, duplicate landmarks, or unnecessary decorative elements.</code></pre>
...
- **Original source:** [@Goodmanprotocol on X](https://x.com/Goodmanprotocol/status/2081298925458461006)
- **Recommended model:** `gptimage`
- **Source model(s):** `gptimage`
- **Categories:** `poster-design`
- **ImgLume record:** [1581](https://imglume.com/prompt/1581)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/fe1cf41f-d259-4e5b-b11e-d754fbd4f974/a171d8fb-c800-49a6-b982-f811dee17ae1-1785086804344 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/fe1cf41f-d259-4e5b-b11e-d754fbd4f974/6882ca2c-2a03-4973-ac50-fd49bacea1ae-1785086804344 "Image prompt preview") · [3](https://cdn.imglume.com/prompts/byradar/fe1cf41f-d259-4e5b-b11e-d754fbd4f974/ea71162c-a4c0-4184-bd76-edb05d91de6d-1785086804344 "Image prompt preview") · [4](https://cdn.imglume.com/prompts/byradar/fe1cf41f-d259-4e5b-b11e-d754fbd4f974/0bb079c5-c3e9-4821-a224-63f1b8e74f1c-1785086804344 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>Create a vertical 3:4 minimalist marker-pen travel poster of NEW YORK CITY on warm ivory paper.
...
- **Original source:** [@ou_zhen599 on X](https://x.com/ou_zhen599/status/2081030585330589721)
- **Recommended model:** `gptimage`
- **Source model(s):** `gptimage`
- **Categories:** `food-drink`, `poster-design`
- **ImgLume record:** [1551](https://imglume.com/prompt/1551)
- **Source media:** [1](https://cdn.imglume.com/prompts/byradar/57186211-62c0-4166-9ad5-9f75ae27d5dd/643f36aa-bbc5-4154-890c-6a41e205bad8-1785059490220 "Image prompt preview") · [2](https://cdn.imglume.com/prompts/byradar/57186211-62c0-4166-9ad5-9f75ae27d5dd/34912764-5145-4897-a44c-0a0ebbb4bff2-1785059490220 "Image prompt preview")
- **Rights:** prompt text and source media `NOASSERTION`; ImgLume curation `CC-BY-4.0`

<details>
<summary>Full prompt</summary>

<pre><code>Create an ultra-premium horizontal 2x2 four-panel Western fine-dining campaign poster for a self-created luxury restaurant brand. The final artwork must feel like a world-class design-annual food advertisement: bold, minimal, product-dominant, collector-grade, and unmistakably high-end. Use a strict four-panel system with absolute visual unity, but make each panel feature a more distinctive signature Western dish with stronger personality, stronger plating identity, and more memorable premium ingredients.
...
Negative prompt:
cheap fast-food look, cluttered garnish, buffet composition, generic steak plate, ordinary salmon fillet, weak dish identity, messy sauce splash, low-detail food texture, fake meat surface, distorted plating, weak typography, small background text, pasted text effect, generic black font, crowded background, low-end menu design, cartoon rendering, muddy lighting, plastic-looking food, low resolution</code></pre>
